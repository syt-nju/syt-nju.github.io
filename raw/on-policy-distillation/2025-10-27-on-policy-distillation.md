...
> Retrieval note: Full article text fetched from the original Thinking Machines Lab Connectionism post HTML; navigation and site chrome removed. DOI 10.64434/tml.20251026.
...
2. The model exhibits strong post-training behavior, ie. instruction following. We will measure this with the commonly-used IF-eval. Instruction-Following Evaluation for Large Language Models(Zhou et al, 2023)
