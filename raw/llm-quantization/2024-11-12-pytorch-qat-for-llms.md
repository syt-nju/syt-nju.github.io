...
> Source: https://pytorch.org/blog/quantization-aware-training/
> Author: PyTorch / Meta
> Collected: 2026-08-10
> Published: 2024-11-12
> License: Unknown
> Completeness: Complete
> Retrieval note: Fetched from pytorch.org blog HTML; navigation chrome removed. Published date from page "Last updated: 2024-11-12".
...
![Llama3-8B fine-tuned on the C4 dataset (en subset) with and without QAT using int8 per token dynamic activations + int4 grouped per channel weights, evaluated on hellaswag and wikitext on a A100 GPU. Note the log scale for wikitext (lower is better).](https://pytorch.org/wp-content/uploads/2024/11/fg1.jpg)
...
### QAT APIs[https://pytorch.org/blog/quantization-aware-training/#qat-apis](https://pytorch.org/blog/quantization-aware-training/#qat-apis)
...
#### Fine-tuning with torchtune[https://pytorch.org/blog/quantization-aware-training/#fine-tuning-with-torchtune](https://pytorch.org/blog/quantization-aware-training/#fine-tuning-with-torchtune)
...
## What is Quantization-Aware Training?[https://pytorch.org/blog/quantization-aware-training/#what-is-quantization-aware-training](https://pytorch.org/blog/quantization-aware-training/#what-is-quantization-aware-training)
...
### QAT in PyTorch[https://pytorch.org/blog/quantization-aware-training/#qat-in-pytorch](https://pytorch.org/blog/quantization-aware-training/#qat-in-pytorch)
...
![torchao QAT flow. This flow involves two steps: (1) prepare, which inserts the fake quantization ops into the model’s linear layers, and (2) convert, which converts these fake quantization ops with actual quantize and dequantize ops after training.](https://pytorch.org/wp-content/uploads/2024/11/fg2-2.png)
...
## Experimental Results[https://pytorch.org/blog/quantization-aware-training/#experimental-results](https://pytorch.org/blog/quantization-aware-training/#experimental-results)
...
#### Int8 Dynamic Activations + Int4 Weight Quantization (8da4w)[https://pytorch.org/blog/quantization-aware-training/#int8-dynamic-activations--int4-weight-quantization-8da4w](https://pytorch.org/blog/quantization-aware-training/#int8-dynamic-activations--int4-weight-quantization-8da4w)
...
![Llama2-7B 8da4w quantization with and without QAT](https://pytorch.org/wp-content/uploads/2024/11/fg3a.png)

**Figure 3a:** Llama2-7B 8da4w quantization with and without QAT

![Llama2-7B 8da4w quantization with and without QAT, evaluated on wikitext (lower is better)](https://pytorch.org/wp-content/uploads/2024/11/fg3b.png)
...
![Llama3-8B 8da4w quantization with and without QAT](https://pytorch.org/wp-content/uploads/2024/11/fg4a.png)

**Figure 4a:** Llama3-8B 8da4w quantization with and without QAT

![Llama3-8B 8da4w quantization with and without QAT, evaluated on wikitext (lower is better)](https://pytorch.org/wp-content/uploads/2024/11/fg4b.png)

**Figure 4b:** Llama3-8B 8da4w quantization with and without QAT, evaluated on wikitext (lower is better)

#### Lower Bit Weight Only Quantization[https://pytorch.org/blog/quantization-aware-training/#lower-bit-weight-only-quantization](https://pytorch.org/blog/quantization-aware-training/#lower-bit-weight-only-quantization)
...
![Llama3-8B 2-bit weight only quantization with and without QAT. Bars with “skip” refer to skipping quantization for the first 3 and last 2 layers of the model, which are more sensitive to quantization.](https://pytorch.org/wp-content/uploads/2024/11/fg5b.png)
...
![Llama3-8B 3-bit weight only quantization with and without QAT. Bars with “skip” refer to skipping quantization for the first 3 and last 2 layers of the model, which are more sensitive to quantization.](https://pytorch.org/wp-content/uploads/2024/11/fg6a.png)
...
#### QAT Overhead[https://pytorch.org/blog/quantization-aware-training/#qat-overhead](https://pytorch.org/blog/quantization-aware-training/#qat-overhead)
...
## Looking Ahead[https://pytorch.org/blog/quantization-aware-training/#looking-ahead](https://pytorch.org/blog/quantization-aware-training/#looking-ahead)
